...
export const mockRoles = [
	...
	},
	{
		...
		permissions: [
			{
				actions: ['*/read', 'FoundationaLLM.Authorization/*'],
				not_actions: [],
				data_actions: [],
				not_data_actions: [],
			},
	...
	role_assignments: [
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/9c0453b0-c2a9-4c55-ac8f-09ba13351ab9',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/f11bab77-6b2a-4b81-9e75-8b737a6ad81e',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/4521bdb9-1b0e-4ad9-a8cd-75727282cbe7',
			display_name: null,
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/59766546-7e39-46a0-aced-9c9be832b437',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/afc304b8-7f91-4968-b6ac-e260a3a7157b',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/76578e16-3624-4feb-bc77-58676e096faf',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/4ff9547b-1cd3-49d3-94cd-311ee68e3ac9',
		...
		},
		{
			...
			object_id:
				'/providers/FoundationaLLM.Authorization/roleAssignments/ca467bb0-f3e9-4d25-bca8-e36d226b80fd',
		...
		},
		{
			...
			object_id:
				'/instances/6fa496ce-d5c0-4e02-9223-06a98c9c0176/providers/FoundationaLLM.Authorization/roleAssignments/1336bd64-d201-4846-9a49-4f8866dd6141',
			...
			principal_type: 'User',
			scope:
				'/instances/6fa496ce-d5c0-4e02-9223-06a98c9c0176/providers/FoundationaLLM.Agent/agents/JoelTest',
			cost_center: null,
