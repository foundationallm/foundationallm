...
user_prompt = "I've uploaded a PNG file. Please use Python to: Load the image. Report its pixel dimensions (width × height). Convert the image to grayscale. Do not use matplotlib. Save and display the new grayscale version."
