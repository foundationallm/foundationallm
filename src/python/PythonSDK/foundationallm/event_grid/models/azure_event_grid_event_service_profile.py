...
class AzureEventGridEventServiceProfile:
    ...
    event_sets: List[EventGridTopicProfile] = Field(default=[], description="The list of EventGridTopicProfile topic profiles used to configure event handling for an Azure Event Grid namespace topic.")
