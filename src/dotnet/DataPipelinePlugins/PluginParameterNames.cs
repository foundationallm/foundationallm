namespace FoundationaLLM.Plugins.DataPipeline
{
    public static class PluginParameterNames
    {
        ...
        public const string KNOWLEDGEEXTRACTION_DATAPIPELINESTAGE_ENTITYEXTRACTIONPROMPTOBJECTID = "EntityExtractionPromptObjectId";
        public const string KNOWLEDGEEXTRACTION_DATAPIPELINESTAGE_ENTITYEXTRACTIONCOMPLETIONMODEL = "EntityExtractionCompletionModel";
