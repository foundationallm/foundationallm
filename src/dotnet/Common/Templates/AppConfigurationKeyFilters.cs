...
namespace FoundationaLLM.Common.Constants.Configuration
{
    ...
    {        
        ...
        /// <summary>
        /// Filter for the configuration section used to identify the storage settings for the FoundationaLLM.Vector resource provider.
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_Vector_Storage =
            "FoundationaLLM:ResourceProviders:Vector:Storage:*";
        
        /// <summary>
        /// Filter for the configuration section used to identify the storage settings for the FoundationaLLM.Context resource provider.
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_Context_Storage =
            "FoundationaLLM:ResourceProviders:Context:Storage:*";
        
        /// <summary>
        /// Filter for the configuration section used to identify the storage settings for the FoundationaLLM.Infrastructure resource provider.
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_Infrastructure_Storage =
            "FoundationaLLM:ResourceProviders:Infrastructure:Storage:*";
        ...
        /// <summary>
        /// Filter for the configuration section for the FoundationaLLM Data Pipeline API.
        /// </summary>
        ...
        /// <summary>
        /// Filter for the configuration section for the FoundationaLLM Data Pipeline Frontend Worker service.
        /// </summary>
        ...
        /// <summary>
        /// Filter for the configuration section for the FoundationaLLM Data Pipeline Backend Worker service.
        /// </summary>
        ...
        /// <summary>
        /// Filter for the configuration section used to identify the settings for Entra ID authentication in the Management Portal.
        /// </summary>
        ...
        /// <summary>
        /// Filter for the configuration section used to identify the settings for the events infrastructure used by the Semantic Kernel API.
        /// </summary>
        ...
        /// <summary>
        /// Filter for the configuration section used to identify the settings for the Microsoft Graph API.
        /// </summary>
