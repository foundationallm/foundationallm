...
namespace FoundationaLLM.Common.Constants.Configuration
{
    ...
    public static class AppConfigurationKeys
    {
        ...
        #region FoundationaLLM:ResourceProviders:AzureAI

        #endregion

        #region FoundationaLLM:ResourceProviders:AzureAI:Storage
        
        /// <summary>
        /// The app configuration key for the FoundationaLLM:ResourceProviders:AzureAI:Storage:AuthenticationType setting.
        /// <para>Value description:<br/>The type of authentication used to connect to the Azure Blob Storage account used by the FoundationaLLM.AzureAI resource provider. Can be one of: AzureIdentity, AccountKey, or ConnectionString.</para>
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_AzureAI_Storage_AuthenticationType =
            "FoundationaLLM:ResourceProviders:AzureAI:Storage:AuthenticationType";
        
        /// <summary>
        /// The app configuration key for the FoundationaLLM:ResourceProviders:AzureAI:Storage:AccountName setting.
        /// <para>Value description:<br/>The name of the Azure Blob Storage account used by the FoundationaLLM.AzureAI resource provider.</para>
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_AzureAI_Storage_AccountName =
            "FoundationaLLM:ResourceProviders:AzureAI:Storage:AccountName";
        ...
        #region FoundationaLLM:ResourceProviders:Context

        #endregion

        #region FoundationaLLM:ResourceProviders:Context:Storage
        
        /// <summary>
        /// The app configuration key for the FoundationaLLM:ResourceProviders:Context:Storage:AuthenticationType setting.
        /// <para>Value description:<br/>The type of authentication used to connect to the Azure Blob Storage account used by the FoundationaLLM.Context resource provider. Can be one of: AzureIdentity, AccountKey, or ConnectionString.</para>
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_Context_Storage_AuthenticationType =
            "FoundationaLLM:ResourceProviders:Context:Storage:AuthenticationType";
        
        /// <summary>
        /// The app configuration key for the FoundationaLLM:ResourceProviders:Context:Storage:AccountName setting.
        /// <para>Value description:<br/>The name of the Azure Blob Storage account used by the FoundationaLLM.Context resource provider.</para>
        /// </summary>
        public const string FoundationaLLM_ResourceProviders_Context_Storage_AccountName =
            "FoundationaLLM:ResourceProviders:Context:Storage:AccountName";
        ...
        /// <summary>
        /// The app configuration key for the FoundationaLLM:APIEndpoints:CoreAPI:Configuration:CompletionResponsePollingIntervalMilliseconds setting.
        /// <para>Value description:<br/>The size in seconds of the polling interval used to check for completion responses.</para>
        /// </summary>
        public const string FoundationaLLM_APIEndpoints_CoreAPI_Configuration_CompletionResponsePollingIntervalMilliseconds =
            "FoundationaLLM:APIEndpoints:CoreAPI:Configuration:CompletionResponsePollingIntervalMilliseconds";
