...
namespace FoundationaLLM.Agent.ResourceProviders
{
            ...
            useInternalReferencesStore: true)
    {
        ...
        private async Task<ResourceProviderUpsertResult> UpdateAgent(ResourcePath resourcePath, string serializedAgent, UnifiedUserIdentity userIdentity)
        {
            ...
            if ((agent is KnowledgeManagementAgent { Vectorization.DedicatedPipeline: true } kmAgent))
            {
        ...
        {
            var directoryPath = $"{_name}/{_instanceSettings.Id}/{agentName}/private-file-storage/";
        ...
        private async Task<ResourceProviderUpsertResult> UpdateAgentFile(string agentName, string fileName, string serializedAgentFile)
        {
            ...
            var filePath = $"{_name}/{_instanceSettings.Id}/{agentName}/private-file-storage/{fileName}";
