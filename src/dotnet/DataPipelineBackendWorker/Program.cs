...
ServiceContext.Initialize(
    ...
    ServiceNames.DataPipelineBackendWorker);
...
builder.Configuration.AddAzureAppConfiguration((Action<AzureAppConfigurationOptions>)(options =>
{
    ...
    options.Select(AppConfigurationKeyFilters.FoundationaLLM_APIEndpoints_DataPipelineBackendWorker_Essentials);
    options.Select(AppConfigurationKeyFilters.FoundationaLLM_APIEndpoints_DataPipelineBackendWorker_Configuration);
}));
...
builder.AddOpenTelemetry(
    AppConfigurationKeys.FoundationaLLM_APIEndpoints_DataPipelineBackendWorker_Essentials_AppInsightsConnectionString,
    ServiceNames.DataPipelineBackendWorker);
...
builder.Services.AddAzureEventGridEvents(
    ...
    AppConfigurationKeySections.FoundationaLLM_Events_Profiles_DataPipelineBackendWorker);
...
builder.AddDataPipelineBackendWorkerService();
...
builder.Services.AddOptions<APIKeyValidationSettings>()
    .Bind(builder.Configuration.GetSection(AppConfigurationKeySections.FoundationaLLM_APIEndpoints_DataPipelineFrontendWorker_Essentials));
