...
VERSION_REGEX='^(nuget-|pypi-|context_api-|user_portal-|core_api-|management_portal-|management_api-|langchain_api-|code_containers-|authorization_api-|orchestration_api-|datapipeline_api-|datapipeline_frontendworker-|datapipeline_backendworker-|gatekeeper_api-)?'
VERSION_REGEX+='([0-9]+\.[0-9]+\.[0-9]+'
# allow optional pre-release like -rc485 or -rc485.1 (numeric, optional ".<num>")
VERSION_REGEX+='(-(alpha|beta|rc|poc|base|post)[1-9][0-9]{2,}(\.[0-9]+)?)?'
VERSION_REGEX+=')$'
