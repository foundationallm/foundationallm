...
VERSION_REGEX='^(nuget-|pypi-|context_api-|user_portal-|core_api-|management_portal-|management_api-|langchain_api-|code_containers-|authorization_api-|orchestration_api-|datapipeline_api-|datapipeline_frontendworker-|datapipeline_backendworker-)?'
