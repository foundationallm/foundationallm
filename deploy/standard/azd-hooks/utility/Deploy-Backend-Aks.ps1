...
$chartNames = @{
    ...
    "gateway-adapter-api"         = "../config/helm/microservice-values.yml"
    ...
    "state-api"                   = "../config/helm/microservice-values.yml"
    "vectorization-api"           = "../config/helm/microservice-values.yml"
    "vectorization-job"           = "../config/helm/microservice-values.yml"
    "context-api"                 = "../config/helm/microservice-values.yml"
    "datapipeline-api"            = "../config/helm/microservice-values.yml"
    "datapipeline-frontendworker" = "../config/helm/microservice-values.yml"
    "datapipeline-backendworker"  = "../config/helm/microservice-values.yml"
}
