...
& ./Deploy-Backend-Images-Aks.ps1 -name $name -aksName $backendAksName -resourceGroup $resourceGroup
...
& ./Deploy-Frontend-Images-Aks.ps1 -name $name -aksName $frontendAksName -resourceGroup $resourceGroup
