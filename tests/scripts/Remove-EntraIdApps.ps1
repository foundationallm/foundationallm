...
Param(
	[parameter(Mandatory=$false)][bool]$interactiveMode = $false
)

# Predefined list of application names to delete
$AppNames = @("FoundationaLLM-DEMO", "FoundationaLLM-Authorization-DEMO", "FoundationaLLM-Management-DEMO-Client", "FoundationaLLM-Management-DEMO", "FoundationaLLM-DEMO-Client")
